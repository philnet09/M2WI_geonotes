 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://jax/", wsdlLocation = "http://localhost:8080/UtilisateurWS/UserServiceService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://jax/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/UtilisateurWS/UserServiceService?WSDL");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://jax/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jax/", "UserServicePort"), UserService.class, features);
    }
